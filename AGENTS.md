# bit-company-website — контекст для Codex
...
- `Session — 2026-05-01 bit-company.ru правки Лёни (5 правок + AGENTS.md)` — правки презентации до split-фикса
- `MOC — BTS Holding` — карта контента holding-связанных заметок

## Auto-memory (Codex) — кросс-проектная

- **bit-company-website project** (этот): `~/.Codex/projects/-Users-jkaseq-Documents-projects-bit-company-website/memory/cross_project_bit_company.md` — полная карта файлов / runbook / гочи / связь с bts-holding и bts-max-bot. Читается автоматически при запуске Codex из этого проекта.
- **bts-holding project** (соседний): `~/.Codex/projects/-Users-jkaseq-Documents-projects-bts-holding/memory/bit_company_landing_presentation_split.md` — для BTS-сессий чтобы знать про этот сайт и не сломать его при `make deploy-back` или nginx-правках.
